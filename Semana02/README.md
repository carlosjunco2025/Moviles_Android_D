...
2. ¿Qué pasaría si intentas cambiar el precio después de crear el producto?
   Kotlin no te deja ni compilar el proyecto. Salta el error Val no se puede reasignar porque las propiedades declaradas como val son solo de lectura y su valor no se puede reasignar.
